...
new #[Layout('layouts::admin')] class extends Component {
    ...
    public function save()
    {
        ...
        $this->dispatch('toast-show', ['message' => 'Project created successfully', 'type' => 'success']);
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 py-6">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-lg font-semibold text-slate-800">Add Project</h1>
            <p class="text-sm text-slate-500">Create project and upload slider images</p>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 space-y-3">
                    <h3 class="text-sm font-semibold text-slate-700">Slider Images</h3>
                    <div class="border-2 border-dashed border-slate-300 rounded-lg p-5 bg-slate-50/60">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-slate-700">Upload Project Slider Images</p>
                                <p class="text-xs text-slate-500 mt-0.5">Multiple JPG/PNG files up to 4MB each. First image becomes primary.</p>
                            </div>
                        </div>
                            ...
                            @foreach($newImages as $index => $image)
                                <div class="border border-slate-200 rounded-md p-2 bg-white">
                                    ...
                                    <div class="mt-1 flex items-center justify-between gap-2">
                                        <p class="text-[11px] text-slate-500">{{ $index === 0 ? 'Primary image' : 'Slider image' }}</p>
                                        <button
                                            type="button"
