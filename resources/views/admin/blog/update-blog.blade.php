        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-6 rounded-xl shadow-sm space-y-4">
                ...
                <div
                    ...
                    <textarea x-ref="editor" class="w-full border rounded-lg p-2 focus:ring-blue-500 focus:border-blue-500 @error('content') border-red-500 @enderror">{{ $content }}</textarea>
                ...
                <div>
                    ...
                    <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-dashed rounded-lg border-gray-300">
                        <div class="space-y-1 text-center">
                            ...
                            @elseif($oldImage)
                            <img src="{{ Storage::url($oldImage) }}" class="mx-auto h-32 w-32 object-cover rounded-lg mb-2">
                            @else
