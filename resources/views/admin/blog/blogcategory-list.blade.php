...
<div>
<h1 class="text-lg sm:text-xl font-semibold text-slate-800">Blog Categories</h1>
<p class="text-sm text-slate-500">Organize blog posts into categories</p>
</div>
...
<th class="px-4 py-3 text-center text-xs font-medium text-slate-500 uppercase">
Posts
</th>
...
{{ App\Models\Blog::where('category_id',$category->id)->count() }}
</td>
...
<i class="ri-folders-line text-4xl mb-2"></i>
